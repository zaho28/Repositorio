...
const Registrar_usuario = () => {
    ...
    // --------------------------------
    // EFECTO PARA CARGAR DATOS (Inicialización)
    // --------------------------------
    useEffect(() => {
    ...
    // --------------------------------
    // FUNCIÓN DE REGISTRO (Manejo del formulario)
    // --------------------------------
    const handleCreate = async (e) => {
        ...
        try {
            const response = await axios.post(`${BASE_URL}/add`, datosUsuario);
    ...
    // --------------------------------
    // RENDERIZADO DEL COMPONENTE (Con clases de Layout)
    // --------------------------------
    return (
