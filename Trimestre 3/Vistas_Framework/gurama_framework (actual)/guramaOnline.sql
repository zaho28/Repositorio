...
-- ===========================================
-- Aqui estan las 10 consultas que elegimos
-- ===========================================
...
INSERT INTO tipo_movimiento (id_m, descripcion_m) 
VALUES ('M-E', 'Entrada de Inventario por Compra o Devolución')
ON DUPLICATE KEY UPDATE 
descripcion_m = 'Entrada de Inventario por Compra o Devolución';