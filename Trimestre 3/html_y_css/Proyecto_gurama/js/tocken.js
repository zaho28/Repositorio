...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm && emailInput && passwordInput && loginButton) {
        // Asegurarse de que el botón no redirija directamente
    ...
    if (adminCodeInput && adminFormContainer) {
        ...
        // 1. Verificar si hay sesión pendiente
        ...
        if (!adminId || !requiredCode) {
            ...
            // Opcional: window.location.href = 'iniciar_sesion.html';
            return;
        }

        // 2. Manejar el envío del formulario de código
            ...
            adminLoginButton.addEventListener('click', () => {
                ...
                if (enteredCode === requiredCode) {
                    ...
                    if (adminUser) {
                        ...
                        window.location.href = 'panel_admin.html'; // Cambia esto a tu página de inicio admin
                    } else {
